 ...
 */
function WxBeacon(temperature, humidity, pressure, rssi, measuredPower, beacon) {
	this.temperature = temperature;
	this.humidity = humidity;
	this.pressure = pressure;
	this.rssi = rssi;
	this.measuredPower = measuredPower;
	this.rawBeacon = beacon;
}
...
WxBeacon.parse = function(beacon) {
	...
	return new WxBeacon(temperature, humidity, pressure, beacon.rssi, beacon.measuredPower, beacon);
};
